...
## Calculate kappa
lr_train_kappa <- cohen.kappa(lr_conf_train)
...
## Calculate kappa
lr_test_kappa <- cohen.kappa(lr_conf_test)
...
## 4 (ii) Ordinal Random Forest

The ordinal random forest model successfully distinguished between individuals with and without heart disease when using a binary outcome, but failed to accurately predict multiple levels of disease severity. This limitation likely stems from a combination of class imbalance and a lack of differentiating features for disease severity.
